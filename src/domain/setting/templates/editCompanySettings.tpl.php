...
?>
<!-- codemirror -->
<script src="<?=BASE_URL?>/js/codemirror.js?v=<?php echo $settings->appVersion; ?>"></script>
<script src="<?=BASE_URL?>/js/mode/css/css.js?v=<?php echo $settings->appVersion; ?>"></script>
						...
						<div id="subscriptionUpdate">
							...
							<div class="widgetcontent">
								...
								<form class="" method="post" id=""
									  action="<?= BASE_URL ?>/setting/editCompanySettings">
									...
									<div class="row">
										...
										<div class="col-md-8">
											<input type="text" name="name"
												   id="companyName"
												   value="<?php echo $companySettings['name']; ?>"/>
									...
									<div class="row">
										...
										<div class="col-md-8">
											<input type="text" id="colorpicker"
												   ...
												   value="<?php echo $companySettings['color']; ?>"/>
											<span id="colorSelector"
												  class="colorselector"><span></span></span>
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-md-4">
											<img src='<?php echo $companySettings['logo'] ?>'
												...
												<div class='fileupload fileupload-new'
													...
													<div class="input-append">
														...
														<a href='#'
														   ...
														   onclick="leantime.usersController.clearCroppie()">Remove</a>
													</div>
													<p class='stdformbutton'>
                                                        <span id="save-logo"
															  class="btn btn-primary fileupload-exists ld-ext-right">
									...
									<div class="row">
										<div class="col-md-2">
											<label for="companysettings.custom_css"><?= $this->__("label.company_css") ?></label>
										</div>
										<div class="col-md-6">
											<textarea cols="15" name="companysettings.customCss" class="companysettings_custom_css"
													  id="companysettings.customCss" rows="20"><?php echo $companySettings['companysettings.customCss']; ?></textarea>
										</div>
									</div>

									<input type="submit"
										   value="<?= $this->__("buttons.save") ?>"
										   id="saveBtn"/>
...
<script>
    ...
    var editor = CodeMirror.fromTextArea(document.getElementById('companysettings.customCss'), {
        lineNumbers: true
    });
